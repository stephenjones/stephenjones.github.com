...
<p>With this background image solution working (for the image), I now had a problem showing the text on the page. I could show the text, or image, but not both. I solved this by including the following:</p>
...
<p>The CSS above includes the classes: 'show' to put back the underlines for links, and 'leftie' to override the template's centering of texti (used on my about page). </p> 
